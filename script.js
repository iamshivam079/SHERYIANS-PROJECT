...
Shery.imageEffect("#imgntxt img", {
  ...
  config: {
    ...
    uFrequencyZ: { value: 30.12, range: [0, 100] },
...
Shery.imageEffect("#bimg", {
  ...
  config: {
    uColor: { value: false },
    uSpeed: { value: 0.74, range: [0.1, 1], rangep: [1, 10] },
    uAmplitude: { value: 0.11, range: [0, 5] },
    uFrequency: { value: 0.08, range: [0, 10] },
    geoVertex: { range: [1, 64], value: 2.44 },
    zindex: { value: -9996999, range: [-9999999, 9999999] },
    aspect: { value: 2.3086454863086048 },
    ignoreShapeAspect: { value: true },
    shapePosition: { value: { x: 0, y: 0 } },
    shapeScale: { value: { x: 0.5, y: 0.5 } },
    shapeEdgeSoftness: { value: 0, range: [0, 0.5] },
